...
const Specialistsdetail = () => {
    ...
    const text = "Lorem ipsum dolor sit amet consectetur. Vulputate ipsum urna sit mus ultrissces maecenas. Iaculis tincidunt condimentum sed urna pellentesque in placerat";
    return (
        <>
            <Header />
            <section className="doctor-profile specialists-detail">
                        ...
                        <div className="parent">
                            ...
                            <div className="right-side-content">
                                <div>
                                    ...
                                    <div className="doctor-detail">
                                        <div className="inner-left">
                                            ...
                                            <div className="rate-text noneformobile">
                                                <h6>$120 / Hour</h6>
                                            </div>
                                        </div>
                                ...
                                <div className="bottom-area">
                                    <p className="para">Lorem ipsum dolor sit amet consectetur. Vehicula in a egestas consectetur cras. Nulla phasellus duis nulla justo ac viverra in ullamcorper senectus. Aliquet sit scelerisque lectus leo varius eu non nulla. Neque nibh viverra sit maecenas nibh porta enim dignissim volutpat.</p>
                                    <Link href="/doctorprofile" className='btn-appointment'>Book appointment </Link>
                                </div>
                            </div>
                        </div>
                        <div className="mobile-parent d-none">
                           <p className="para-mobile">Lorem ipsum dolor sit amet consectetur. Vehicula in a egestas consectetur cras. Nulla phasellus duis nulla justo ac viverra in ullamcorper senectus. Aliquet sit scelerisque lectus leo varius eu non nulla. Neque nibh viverra sit maecenas nibh porta enim dignissim volutpat.</p>
                                <Link href="/doctorprofile" className='btn-appointment'>Book appointment</Link>
                        </div>
                    </div>
                    <div className="doctor-qualification">
                        <div className="left-side">
                            <h4 className="heading">Qualifications and Experience</h4>
                            <h6>Specialty: <span>Podiatrists</span></h6>
                            <h5>Areas of Expertise:</h5>
                            <ul>
                                <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M5 13L9 17L19 7" stroke="#29D19E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>Quia rem est sed impedit magnam Quia rem est </li>
                                <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M5 13L9 17L19 7" stroke="#29D19E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>Quia rem est sed impedit magnam Quia rem est </li>
                                <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <h6>Education:  <span>Bachelor of Medicine</span></h6>
                            <h6>Languages:  <span>English, Turkish, Arabic</span></h6>
                        </div>
                        <div className="right-side">
                            ...
                            <div>
                                {text.length > 100 && !showFullText ? (
                                    <>
                                        ...
                                        <a onClick={toggleText} className='btn-read'>Read more</a>
                                    </>
                                ) : (
                                    <p>{text}</p>
                                )}
                            ...
                            <div className="inner-text">
                                <div className="text">
                                    <p>Location</p>
                                    <h6><img src="\assets\dummy\saudia-icon-small.svg" alt="img" className='img-fluid me-2' />Riyadh, KSA</h6>
                                </div>
                                <div className="text">
                                    <p>Mobile Phone</p>
                                    <h6>0125469874102</h6>
